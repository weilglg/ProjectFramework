...
public class TagWithDeleteButtonView extends ViewGroup implements OnClickListener,
        OnLongClickListener {
    ...
    public TagWithDeleteButtonView(Context context) {
        super(context);

        this.readStyleParameters(context, null);
    }

    public TagWithDeleteButtonView(Context context, AttributeSet attributeSet) {
